...
insert into зверек_вид(ид_зверек, ид_вид) values (1, 'телепат');
insert into зверек_вид(ид_зверек, ид_вид) values (2, 'огненный');
insert into зверек_вид(ид_зверек, ид_вид) values (3, 'водный');
insert into зверек_вид(ид_зверек, ид_вид) values (4, 'земляной');
insert into зверек_вид(ид_зверек, ид_вид) values (5, 'водный');
insert into зверек_вид(ид_зверек, ид_вид) values (5, 'земляной');
insert into зверек_вид(ид_зверек, ид_вид) values (6, 'телепат');
insert into зверек_вид(ид_зверек, ид_вид) values (6, 'телепат');
